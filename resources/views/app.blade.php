    ...
    <div id="main-wrapper">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end mailbox animated bounceInDown">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="ae3cee5f-e9ea-3b7b-c53a-0c46fd405481">
                                            <!-- Message -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mailbox dropdown-menu-end animated bounceInDown" aria-labelledby="2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center ps ps--theme_default" data-ps-id="74b2870e-0189-95db-b781-4366c2c31eec">
                                            <!-- Message -->
                                            <a href="javascript:void(0)">
        ...
        <div class="page-wrapper" style="min-height: 905px;">
            ...
            <div class="container-fluid">
                ...
                <!-- .right-sidebar -->
                <div class="right-sidebar ps ps--theme_default" data-ps-id="a916a1f6-f517-9cd4-ad4b-0107d4416d58">
